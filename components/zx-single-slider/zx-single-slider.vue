<template>
	...
	>
		...
		></view>
		<text
			class="zx-sg-slider-bar zx-block"
			:class="barClass"
			:style="{
				width: barWidth + 'rpx',
				height: barHeight + 'rpx',
...
export default {
	...
	props: {
		...
		barClass: {
			type: Array,
			default: function() {
				return ['zx-bg-primary', 'zx-color-white'];
			}
		},
