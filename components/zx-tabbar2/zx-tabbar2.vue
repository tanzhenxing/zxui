<template>
	<view class="zx-tabbar"
		:class="{ 'zx-tabbar-fixed': isFixed, 'zx-unlined': unlined, 'zx-backdrop__filter': backdropFilter }"
		:style="{ background: backgroundColor, zIndex: isFixed ? zIndex : 'auto' }">
		<block v-for="(item, index) in tabBar" :key="index">
			<view class="zx-tabbar-item" :class="{ 'zx-item-hump': item.hump }"
