<template>
	<!-- #ifndef APP-NVUE -->
	<view class="u-grid-item" hover-class="u-grid-item--hover-class" :hover-stay-time="200" @tap="clickHandler" :class="classes" :style="[itemStyle]">
		<slot />
	</view>
	<!-- #endif -->
	<!-- #ifdef APP-NVUE -->
 ...
 * @tutorial https://zxui.org/components/grid.html
...
$u-grid-item-border-right-color: #dadbde !default;
$u-grid-item-border-bottom-color: #dadbde !default;
.u-grid-item {
	align-items: center;
