<template>
	<view class="zx-avatar" :class="[`zx-avatar--${shape}`]"
		:style="[{backgroundColor: text || icon ? (randomBgColor ? colors[colorIndex !== '' ? colorIndex : this.random(0, 19)] : bgColor) : 'transparent',width: size,height: size},customStyle]"
		@tap="clickHandler">
		<slot>
			...
			<zx-text v-else-if="text" :text="text" :size="fontSize" :color="color" align="center" customStyle="justify-content: center"></zx-text>
			<image v-else class="zx-avatar__image"
