<template>
	<view @touchmove.stop.prevent="stop" v-if="isFixed">
		<view class="zx-bottom-popup" :class="{'zx-popup-show': isShow}">
			<view class="zx-calendar-header" :class="{ 'zx-calendar-radius': radius }">
				<view>{{title}}</view>
				<view class="zx-iconfont zx-font-close" hover-class="zx-opacity" :hover-stay-time="150" @tap="hide">
				</view>
			</view>

			<view class="zx-date-box">
				<view class="zx-iconfont zx-font-arrowleft" :style="{ color: yearArrowColor }"
					hover-class="zx-opacity" :hover-stay-time="150" v-if="arrowType == 1" @tap="changeYear(0)"></view>
				<view class="zx-iconfont zx-font-arrowleft" :style="{ color: monthArrowColor }"
					hover-class="zx-opacity" :hover-stay-time="150" @tap="changeMonth(0)"></view>
				<view class="zx-date_time">{{ showTitle }}</view>
				<view class="zx-iconfont zx-font-arrowright" :style="{ color: monthArrowColor }"
					hover-class="zx-opacity" :hover-stay-time="150" @tap="changeMonth(1)"></view>
				<view class="zx-iconfont zx-font-arrowright" :style="{ color: yearArrowColor }"
					hover-class="zx-opacity" :hover-stay-time="150" v-if="arrowType == 1" @tap="changeYear(1)"></view>
			</view>
			<view class="zx-date-header">
				<view class="zx-date">日</view>
				<view class="zx-date">一</view>
				<view class="zx-date">二</view>
				<view class="zx-date">三</view>
				<view class="zx-date">四</view>
				<view class="zx-date">五</view>
				<view class="zx-date">六</view>
			</view>
			<view class="zx-date-content" :class="{ 'zx-flex-start': isFixed && fixedHeight }"
				:style="{ height: isFixed && fixedHeight ? dateHeight * 6 + 'px' : 'auto' }">
				<block v-for="(item, index) in weekdayArr" :key="index">
					<view class="zx-date"></view>
				</block>
				<view class="zx-date" :class="{
						'zx-date-pd_0': isFixed && fixedHeight,
						'zx-opacity': openDisAbled(year, month, index + 1),
						'zx-start-date': (type == 2 && startDate == `${year}-${month}-${index + 1}`) || type == 1,
						'zx-end-date': (type == 2 && endDate == `${year}-${month}-${index + 1}`) || type == 1
					...
					<view class="zx-date-text"
						...
						<view v-if="!getStatusData(4, index)" class="zx-custom-desc"
							:class="{ 'zx-lunar-unshow': !lunar && isFixed }">
							{{ getDescText(index, startDate, endDate) }}
						</view>
						<text class="zx-iconfont zx-font-check" v-if="getStatusData(4, index)"></text>
					</view>
					<view class="zx-date-desc" :style="{ color: activeColor }"
				...
				<view class="zx-bg-month">{{ month }}</view>
			</view>

			<view class="zx-calendar-op">
				<view class="zx-calendar-result">
					<text>{{ type == 1 ? activeDate : startDate }}</text>
					<text v-if="endDate">至{{ endDate }}</text>
				</view>
				<view class="zx-calendar-btn_box">
					<zx-button :type="btnType" height="72rpx" shape="circle" :size="28" :disabled="disabled"
		...
		<view class="zx-popup-mask" :class="[isShow ? 'zx-mask-show' : '']" @tap="hide"></view>
	</view>
	<view v-else>
		<view class="zx-date-box">
			<view class="zx-iconfont zx-font-arrowleft" :style="{ color: yearArrowColor }" hover-class="zx-opacity"
				:hover-stay-time="150" v-if="arrowType == 1" @tap="changeYear(0)"></view>
			<view class="zx-iconfont zx-font-arrowleft" :style="{ color: monthArrowColor }" hover-class="zx-opacity"
				:hover-stay-time="150" @tap="changeMonth(0)"></view>
			<view class="zx-date_time">{{ showTitle }}</view>
			<view class="zx-iconfont zx-font-arrowright" :style="{ color: monthArrowColor }" hover-class="zx-opacity"
				:hover-stay-time="150" @tap="changeMonth(1)"></view>
			<view class="zx-iconfont zx-font-arrowright" :style="{ color: yearArrowColor }" hover-class="zx-opacity"
		...
		<view class="zx-date-content" :style="{ height: isFixed && fixedHeight ? dateHeight * 6 + 'px' : 'auto' }">
			<block v-for="(item, index) in weekdayArr" :key="index">
				<view class="zx-date"></view>
			</block>
			<view class="zx-date" :class="{
...
<script>
	import calendar from './zx-calendar.js';
	export default {
		name: 'zx-calendar2',
		emits: ['hide', 'change'],
		// components:{
...
<style scoped>
	...
	.zx-font-close:before {
		content: '\e608';
	}

	.zx-font-check:before {
		content: '\e6e1';
	}

	.zx-font-arrowright:before {
		content: '\e600';
	}

	.zx-font-arrowleft:before {
		content: '\e601';
	}
