<template>
	<view class="zx-circular-container" :style="{ width: diam + 'px', height: (height || diam) + 'px' }">
		<!-- #ifndef MP-ALIPAY -->
		<canvas class="zx-circular-default" :canvas-id="defaultCanvasId" :id="defaultCanvasId"
			:style="{ width: diam + 'px', height: (height || diam) + 'px' }" v-if="defaultShow"></canvas>
		<canvas class="zx-circular-progress" :canvas-id="progressCanvasId" :id="progressCanvasId"
