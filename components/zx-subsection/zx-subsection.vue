<template>
	<view class="u-subsection" ref="u-subsection" :class="[`u-subsection--${mode}`]" :style="[$u.addStyle(customStyle), wrapperStyle]">
		<view
			...
			:class="[
				...
				current === 0 && mode === 'subsection' && 'u-subsection__bar--first',
				current > 0 && current < list.length - 1 && mode === 'subsection' && 'u-subsection__bar--center',
				current === list.length - 1 && mode === 'subsection' && 'u-subsection__bar--last'
			]"
		></view>
		<view
			...
			:key="index"
		>
			<text class="u-subsection__item__text" :style="[textStyle(index)]">{{ getText(item) }}</text>
		</view>
	</view>
</template>
 ...
 * @tutorial https://zxui.org/components/subsection
