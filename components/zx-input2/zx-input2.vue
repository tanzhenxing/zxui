<template>
	<view :class="{'zx-input__border':inputBorder,'zx-radius__fillet':isFillet}" :style="{marginTop:marginTop+'rpx'}"
		@tap="fieldClick">
		<view class="zx-input__wrap"
			:class="{'zx-line__left':lineLeft,'zx-border__top':!borderTop || inputBorder,'zx-border__bottom':!borderBottom || inputBorder,'zx-radius__fillet':isFillet}"
			:style="{padding:padding,backgroundColor:backgroundColor}">
			<!-- #ifdef APP-NVUE -->
			<view class="zx-input__required" v-if="required">
				<text :style="{color:requiredColor}">*</text>
			</view>
			<!-- #endif -->
			<!-- #ifndef APP-NVUE -->
			<view class="zx-input__required" :style="{color:requiredColor}" v-if="required">*</view>
			<!-- #endif -->
			<view class="zx-input__label"
			...
			<slot name="left"></slot>
			<input class="zx-input__self" :class="{'zx-text__right':textRight}"
				:style="{fontSize:size+'rpx',color:color}" placeholder-class="zx-input__placeholder" :type="type"
...
<style scoped>
	...
	.zx-border__top::before {
		border-top: 0;
	}

	.zx-border__bottom::after {
		border-bottom: 0;
	}
