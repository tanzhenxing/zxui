<template>
	<zx-transition mode="fade" :show="isShow">
		...
		>
			...
			<slot name="right">
				<view v-if="closable" class="zx-alert__shrink" @click="close">
					<zx-icon name="close" :size="closeSize" :color="effect === 'light' ? lightColor : closeColor"></zx-icon>
				</view>
			</slot>
		</view>
	</zx-transition>
...
const getColorClass = computed(() => {
	let colorClass = 'zx';
	if (props.type) {
		colorClass += '-' + props.type;
	}
	if (props.effect) {
		colorClass += '-' + props.effect;
	}
	return colorClass;
});
