<template>
	<view>
		<view class="box">
			<view class="pendant">
				<zx-icon name="weixin-fill" :size="iconSize" :color="iconColor" @click="openQrcode"></zx-icon>
			</view>
			<zx-gap height="20rpx"></zx-gap>
			<view class="pendant">
				<zx-icon name="phone-fill" :size="iconSize" :color="iconColor" @click="openPhone"></zx-icon>
			</view>
		</view>
		<!-- 微信二维码 弹窗 -->
		<zx-popup :show="qrcodeShow" mode="center" round="30rpx" :closeable="true" 
		:overlayOpacity="0.8"
		...
		<!-- 联系电话 弹窗 -->
		<zx-popup :show="phoneShow" mode="center" round="30rpx" :closeable="true"
		:overlayOpacity="0.8"
		:closeOnClickOverlay="false" 
		:zIndex="10074" 
		@close="closePhone">
...
<style lang="scss">
	.box {
		position: fixed; right: 10px;bottom: 100px;width: 50px;z-index: 100;
	}
.pendant {
		width: 80rpx;
		height: 80rpx;
