<template>
	<view class="u-switch" :class="[disabled && 'u-switch--disabled']" :style="[switchStyle, $u.addStyle(customStyle)]" @tap="clickHandler">
		<view class="u-switch__bg" :style="[bgStyle]"></view>
		<view class="u-switch__node" :class="[value && 'u-switch__node--on']" :style="[nodeStyle]" ref="u-switch__node">
			<u-loading-icon :show="loading" mode="circle" timingFunction="linear" :color="value ? activeColor : '#AAABAD'" :size="size * 0.6" />
		</view>
	</view>
</template>
